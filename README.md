...
For Individual Developers
    ...
    Install CLI tool globally: npm install -g codeflow-hook
    Configure AI: codeflow-hook config -k <key>
    Enable in any project: codeflow-hook install
    Get AI feedback on every commit and push
...
Development Setup
    ...
    Work on CLI tool in cli-tool/ directory
    Test changes across both components
